...
def generate_Answer(question: str, llm):
    ...
    system_instruction = (
        ...
        "Приоритет товаров: Если в базе несколько подходящих товаров, выводи 2-3 наиболее релевантных (например, Original OE и качественный аналог).\n\n"
        ""
...
if __name__ == "__main__":
    ...
    test_q = [ "Volvo s60 2010 масло трансмиссионное",
        "Подбери масло в ДВС лада гранта 2020, 1.6 л",
               ...
               "Как Бабе Яге подготовить еë дизельную ступу к холодному пуску?",
